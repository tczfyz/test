...
<html>
  <head>
    ...
    <title>文字资料</title><LINK href="CSS.css" type=text/css 
rel=stylesheet>
...
%>
  <tr>
    ...
    <td width="60" align="center"><a href="xinwentongzhi_updt.jsp?id=<%=id%>">修改</a>  <a href="delgg.jsp?id=<%=id %>&tablename=xinwentongzhi" onClick="return confirm('真的要删除？')">删除</a></td>
  </tr>
  	<%
  }
   %>
