...
<html>
  <head>
    <base href="<%=basePath%>">
    <title>资料下载</title><LINK href="CSS.css" type=text/css rel=stylesheet><script language="javascript" src="js/Calendar.js"></script>
  </head>
  <%
String sql;
ResultSet RS_result;
...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse">  
  <tr>
    ...
    <td bgcolor='#CCFFFF'>编号</td><td bgcolor='#CCFFFF'>名称</td><td bgcolor='#CCFFFF'>类别</td><td bgcolor='#CCFFFF'>课程</td><td bgcolor='#CCFFFF'>简介</td><td bgcolor='#CCFFFF'>附件</td>
...
%>
  <tr>
    ...
    <td width="90" align="center"><a href="ziliaoxiazai_updt.jsp?id=<%=id%>">修改</a>  <a href="del.jsp?id=<%=id %>&tablename=ziliaoxiazai" onClick="return confirm('真的要删除？')">删除</a> <a href="ziliaoxiazaidetail.jsp?id=<%=id%>" target="_blank">详细</a></td>
  </tr>
  	<%
  }
   %>
